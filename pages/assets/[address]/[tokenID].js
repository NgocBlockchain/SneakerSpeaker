...
function NFT() {
  ...
  const marketplace = useMarketplace("0x25Eb8777d5D877B5D03C84D14B86C4826B93aa69")
  ...
  const style = {
    wrapper: `h-[100vh] mx-auto flex max-w-2xl flex-col space-y-4 p-4 dark:bg-[#F4F4F2] lg:max-w-none lg:py-8 lg:px-24`,
        ...
        {loading ? (
          ...
          <div className={style.nftContainer}>
            <div className={style.leftContainer}>
              ...
              <div className={style.leftElement}>
                <NFTDetails description={listing?.asset?.description} properties={listing?.asset?.attributes}/>

...
const style = {
  ...
  header: `flex items-center justify-between rounded-t-lg px-6 py-4 dark:bg-[#F7F7F7]`,
  headerContent: `flex items-center space-x-2`,
  headerIcon: `h-6 w-6`,
  greyText: `text-gray-500`,
  mainContainer: `space-y-4 rounded-b-lg px-6 py-4 dark:bg-[#F7F7F7]`,
  ...
  purchaseButton: `bg-blue-500 hover:bg-blue-900`,
  offerButton: `border border-black bg-[#363840] hover:bg-black`,
  buttonIcon: `h-6 w-6`,
}
